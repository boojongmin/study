...
class ListViewTest(TestCase):
    ...
    def test_displays_only_items_for_that_list(self):
        ...
        self.assertNotIn('other itemey 1', response.content.decode())
        self.assertNotIn('other itemey 2', response.content.decode())
...
class NewListViewTest(TestCase):
    ...
    # def test_saving_and_retrieve_list(self):
    #     list = List.objects.create()
...
class NewItemTest(TestCase):
    ...
    def test_can_save_a_POST_request_to_an_existing_list(self):
        ...
        self.client.post(
            ...
            data = {'item_text': 'add new item from legacy list'}
        )

        self.assertEqual(Item.objects.count(), 1)
        new_item = Item.objects.first()
        self.assertEqual(new_item.text, 'add new item from legacy list')
